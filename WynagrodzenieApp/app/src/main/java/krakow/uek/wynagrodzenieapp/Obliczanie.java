...
public class Obliczanie extends AppCompatActivity {
    ...
    public void adder(View view) {
        ...
        switch (state)
        {
            case 1:((EditText)findViewById(R.id.editText9)).setVisibility(View.VISIBLE);break;
            case 2:((EditText)findViewById(R.id.editText8)).setVisibility(View.VISIBLE);break;
            case 3:((EditText)findViewById(R.id.editText7)).setVisibility(View.VISIBLE);break;
            case 4:((EditText)findViewById(R.id.editText6)).setVisibility(View.VISIBLE);break;
            default:break;
        }
